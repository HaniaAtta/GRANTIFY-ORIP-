...
# Determine if grant opportunity is open (with date logic)
def is_grant_open(text, keywords):
    ...
    # Optional: check for a future-valid date
...
# Scraper function for Counterpart International
def scrape_counterpart(url="https://www.counterpart.org/business-opportunities/"):
    custom_keywords = [
       "now","open","apply now"
        "funding opportunity",
        "contract",
