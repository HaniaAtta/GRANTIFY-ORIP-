...
# Determine if the content suggests an open funding opportunity
def is_grant_open(text, keywords):
    ...
    # Optional: future-valid date detection
...
# Scraper for Food & Water Watch
def scrape_foodandwaterwatch(url="https://www.foodandwaterwatch.org"):
    custom_keywords = [
...
# Manual test run
# def main():
#     result = scrape_foodandwaterwatch()
#     print("Result:", result)
