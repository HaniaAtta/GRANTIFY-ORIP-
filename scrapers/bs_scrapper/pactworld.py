...
# Determine if the grant is open based on keywords and date
def is_grant_open(text, keywords):
    ...
    # Optional: parse and validate any future-looking date
...
# Scraper function for PactWorld
def scrape_pactworld(url="https://www.pactworld.org/procurement"):
    custom_keywords = [
