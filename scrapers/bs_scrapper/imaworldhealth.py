...
# Check if text indicates an open grant
def is_grant_open(text, keywords):
    ...
    # Optional: Check for a future deadline
...
# Scraper for IMA World Health
def scrape_imaworldhealth(url="https://imaworldhealth.org/contracting-opportunities"):
    custom_keywords = [
        "call for proposals", "applications are open", "apply now", "deadline to apply is",
        "rfp open" "submission deadline",
