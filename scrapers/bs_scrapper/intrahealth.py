...
# Check if page text suggests an open grant (with date logic)
...
# IntraHealth scraper function
def scrape_intrahealth(url="https://www.intrahealth.org/proposal-opportunities"):
    custom_keywords = [
        "open now", 
        "apply for proposals", 
        "current proposals opportunity"
    ]
...
# Main function for manual test
# def main():
#     result = scrape_intrahealth()
#     print("Result:", result)
