...
# Check if the content indicates an open grant
def is_grant_open(text, keywords):
    ...
    # Optional: check for valid future date
...
# Scraper function
def scrape_savethechildren(url="https://www.savethechildren.org/us/about-us/contact-us/rfp"):
    custom_keywords = [
        'rfp open', 'submit proposal', 'solicitation open', 'open',
        'contracting opportunity', 'submission deadline', 'open rfp'
    ]
