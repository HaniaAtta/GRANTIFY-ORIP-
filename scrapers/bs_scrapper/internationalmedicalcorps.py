...
# Determine if a grant is open (with date logic)
...
# Scraper function for International Medical Corps
def scrape_internationalmedicalcorps(url="https://internationalmedicalcorps.org/who-we-are/accountability-financials/open-tenders/"):
    custom_keywords = [
        "open tenders by country"
    ]
...
# def main():
#     result = scrape_internationalmedicalcorps()
#     print("Result:", result)
